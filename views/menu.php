...
<form method="post" class="">
    ...
    <div class="mr-14 ">
        ...
        <p><button type="submit" name="calendarActual" class="p-3 my-3 bg-transparent border-green rounded-full border-2 md:min-w-full focus:outline-none
               focus:border-green hover:text-black hover:bg-green transition ease-in-out duration-500">Aktuální rozvrh</button></p>
        <p><button type="submit" name="calendarNextWeek" class="p-3 my-3  bg-transparent border-green rounded-full border-2 md:min-w-full focus:outline-none
               focus:border-green hover:text-black hover:bg-green transition ease-in-out duration-500">Rozvrh na příští týden</button></p>
        <p><button type="submit" name="calendarPermanent" class="p-3 my-3  bg-transparent border-green rounded-full border-2 md:min-w-full focus:outline-none
    ...
    <div class="right">
        ...
        <p><button type="submit" name="delete_next" class="p-3 my-3  bg-transparent border-orange rounded-full border-2 md:min-w-full focus:outline-none
        ...
        <p><button type="submit" name="deletePermanent" class="p-3 my-3  bg-transparent border-orange rounded-full border-2 md:min-w-full focus:outline-none
        ...
        <p><button type="submit" name="delete" class="p-3 my-3  bg-transparent border-orange rounded-full border-2 md:min-w-full focus:outline-none
    ...
    <div class="">
        ...
        <p><label for="timer">Čas (min)</label>
            <input type="number" id="timer" name="timer" min="1" max="20" value="5" class="text-center bg-transparent border-white border-2 rounded-full focus:border-blue focus:outline-none transition ease-in-out duration-500"></p>
    </div>
</form>