...
<form method="post" class="mb-4">
    ...
    <div class="p-3">
        ...
        <p><button type="submit" name="calendarActual" id="calendarActual" class="p-3 my-3 bg-transparent border-green rounded-full border-2 min-w-1/2 sm:min-w-full focus:outline-none
    ...
    <div class="">
        <p><label for="reminder" >Upozornění</label>
            <input type="checkbox" id="reminder" name="reminder" value="true" checked="true" class="mb-4"></p>
        <p><label for="timer">Čas před (min)</label>
...
<hr class="bg-orange max-w-1/2 mx-auto border-0 h-px mb-3 md:mb-5">
<form action="" method="post">
    <p>Rozvh se bude nahrávat z účtu: <i><?=$bakaUserType ?> </i> - <b> <?= $bakaName?> </b> </p>
    <p>Aktuálně se rozvrh bude nahrávat na <b><?=$microsoftMail ?></b> </p>
    <p><button type="submit" name="logoutMicrosoft" class="p-3 my-3  bg-transparent border-orange rounded-full border-2 min-w-1/2 focus:outline-none
               focus:border-red-600 focus:bg-red-500 hover:text-white hover:bg-orange transition ease-in-out duration-500">Odhlásit se z <b><?=$microsoftMail ?></b></button></p>
</form>